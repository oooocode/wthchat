...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        packageConfig.setParent("com.wth.chat.common.user");//自定义包的路径
...
//        strategyConfig.setTableFillList(list);
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setPassword("wth123");
        dataSourceConfig.setUrl("jdbc:mysql://43.142.126.61:3306/wthchat?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
}